...
-- CreateIndex
CREATE INDEX "Assessment_testId_idx" ON "Assessment"("testId");
...
-- AddForeignKey
ALTER TABLE "Assessment" ADD CONSTRAINT "Assessment_testId_fkey" FOREIGN KEY ("testId") REFERENCES "Test"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
